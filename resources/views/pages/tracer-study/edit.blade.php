        ...
        <div class="p-6">
            ...
            <form action="{{ route('tracer-study.update', $tracer->id) }}" method="POST" class="space-y-6" 
                ...
                <div>
                    ...
                    <input type="text" id="nama_alumni" name="nama_alumni" value="{{ old('nama_alumni', $tracer->nama_alumni) }}" placeholder="Masukkan nama lengkap alumni" required
                ...
                <div>
                    ...
                    <input type="number" id="tahun_lulus" name="tahun_lulus" value="{{ old('tahun_lulus', $tracer->tahun_lulus) }}" placeholder="e.g. 2024" required
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="detail_status" name="detail_status" value="{{ old('detail_status', $tracer->detail_status) }}" :placeholder="detailPlaceholder"
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                </div>
