...
@section('content')
    ...
    <div class="mx-auto max-w-2xl">
        <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <form action="{{ route('bk.alumni-kuliah.store') }}" method="POST">
                @csrf

                {{-- Nama Alumni --}}
                <div class="mb-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama Alumni *</label>
                    <input type="text" name="nama_alumni" value="{{ old('nama_alumni') }}" class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 dark:border-gray-600 dark:bg-white/5 @error('nama_alumni') border-red-500 @enderror" placeholder="Nama lengkap alumni">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nis" value="{{ old('nis') }}" class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 dark:border-gray-600 dark:bg-white/5 @error('nis') border-red-500 @enderror" placeholder="Nomor induk siswa">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="tahun_lulus" value="{{ old('tahun_lulus') }}" min="2000" max="{{ date('Y') }}" class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 dark:border-gray-600 dark:bg-white/5 @error('tahun_lulus') border-red-500 @enderror" placeholder="2024">
                ...
                <div class="mb-4">
                    ...
                    <select name="universitas_id" id="universitasSelect" class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 dark:border-gray-600 dark:bg-white/5 @error('universitas_id') border-red-500 @enderror">
                        ...
                        @foreach($universitas as $u)
                            <option value="{{ $u->id }}" data-lokasi="{{ $u->lokasi_kuliah }}" {{ old('universitas_id') == $u->id ? 'selected' : '' }}>
                                {{ $u->nama_universitas }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="program_studi" value="{{ old('program_studi') }}" class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 dark:border-gray-600 dark:bg-white/5 @error('program_studi') border-red-500 @enderror" placeholder="Teknologi Informasi">
                ...
                <div class="mb-4">
                    ...
                    <select name="cara_masuk" class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 dark:border-gray-600 dark:bg-white/5 @error('cara_masuk') border-red-500 @enderror">
                        ...
                        <option value="snbp" {{ old('cara_masuk') === 'snbp' ? 'selected' : '' }}>SNBP</option>
                        <option value="utbk" {{ old('cara_masuk') === 'utbk' ? 'selected' : '' }}>UTBK</option>
                        <option value="ujian_masuk" {{ old('cara_masuk') === 'ujian_masuk' ? 'selected' : '' }}>Ujian Masuk Mandiri</option>
                        <option value="beasiswa" {{ old('cara_masuk') === 'beasiswa' ? 'selected' : '' }}>Beasiswa</option>
                        <option value="transfer" {{ old('cara_masuk') === 'transfer' ? 'selected' : '' }}>Transfer</option>
                        <option value="lainnya" {{ old('cara_masuk') === 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input type="email" name="email_alumni" value="{{ old('email_alumni') }}" class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 dark:border-gray-600 dark:bg-white/5 @error('email_alumni') border-red-500 @enderror" placeholder="alumni@email.com">
                ...
                <div class="mb-4">
                    ...
                    <input type="tel" name="nomor_telepon" value="{{ old('nomor_telepon') }}" class="mt-2 w-full rounded-lg border border-gray-300 px-4 py-2 dark:border-gray-600 dark:bg-white/5 @error('nomor_telepon') border-red-500 @enderror" placeholder="081234567890">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('bk.alumni-kuliah.index') }}" class="flex-1 rounded-lg border border-gray-300 px-6 py-2 font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-white/5 text-center transition">
                        Batal
                    </a>
                </div>
            </form>
