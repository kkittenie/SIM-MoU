@extends('layouts.app', ['title' => 'Ubah Alumni Wirausaha'])

@section('content')
    <x-common.page-breadcrumb pageTitle="Ubah Alumni Wirausaha" />

    <div class="mx-auto max-w-2xl">
        <div class="rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-800 dark:bg-white/[0.03]">
            <h2 class="mb-6 text-2xl font-bold text-gray-800 dark:text-white">Ubah Data Alumni Wirausaha</h2>

            <form action="{{ route('bk.alumni-wirausaha.update', $alumniWirausaha->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="nama_alumni" value="{{ old('nama_alumni', $alumniWirausaha->nama_alumni) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="nama_usaha" value="{{ old('nama_usaha', $alumniWirausaha->nama_usaha) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="bidang_usaha" value="{{ old('bidang_usaha', $alumniWirausaha->bidang_usaha) }}" required
                ...
                <div>
                    ...
                    <input type="text" name="lama_usaha" value="{{ old('lama_usaha', $alumniWirausaha->lama_usaha) }}" required
                ...
                <div>
                    ...
                    <input type="number" name="tahun_lulus" value="{{ old('tahun_lulus', $alumniWirausaha->tahun_lulus) }}" min="2000" max="{{ date('Y') + 5 }}" required
