                                ...
                                <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.01] transition-colors">
                                    ...
                                    <td class="px-6 py-4 text-xs">
                                        <details class="cursor-pointer text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
                                            ...
                                            <div class="mt-2 p-2 bg-gray-50 dark:bg-white/[0.02] border border-gray-150 dark:border-gray-800 rounded-md font-mono text-[10px] whitespace-pre-wrap max-w-xs overflow-x-auto">
                                                {{ $log->response }}
                                            </div>
                                        </details>
                                    </td>
