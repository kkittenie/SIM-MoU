@extends('layouts.app', ['title' => 'Ubah Perusahaan Mitra'])

@section('content')
    <x-common.page-breadcrumb pageTitle="Ubah Perusahaan Mitra" />
    ...
    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] shadow-xs max-w-2xl">
        <div class="p-6 border-b border-gray-100 dark:border-gray-800">
            <h3 class="text-base font-semibold text-gray-800 dark:text-white/90">
                Formulir Ubah Perusahaan Mitra
            </h3>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Ubah informasi perusahaan mitra di bawah ini.
            </p>
        </div>
        ...
        <div class="p-6">
            ...
            <form action="{{ route('bkk.perusahaan-mitra.update', $mitra->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" id="nama_perusahaan" name="nama_perusahaan" value="{{ old('nama_perusahaan', $mitra->nama_perusahaan) }}" placeholder="Masukkan nama perusahaan" required
                ...
                <div>
                    ...
                    <select id="bidang_industri" name="bidang_industri" required
                        ...
                        <option value="Teknologi" {{ old('bidang_industri', $mitra->bidang_industri) === 'Teknologi' ? 'selected' : '' }}>Teknologi / IT</option>
                        <option value="Manufaktur" {{ old('bidang_industri', $mitra->bidang_industri) === 'Manufaktur' ? 'selected' : '' }}>Manufaktur</option>
                        <option value="Keuangan" {{ old('bidang_industri', $mitra->bidang_industri) === 'Keuangan' ? 'selected' : '' }}>Keuangan / Perbankan</option>
                        <option value="Kesehatan" {{ old('bidang_industri', $mitra->bidang_industri) === 'Kesehatan' ? 'selected' : '' }}>Kesehatan / Farmasi</option>
                        <option value="Telekomunikasi" {{ old('bidang_industri', $mitra->bidang_industri) === 'Telekomunikasi' ? 'selected' : '' }}>Telekomunikasi</option>
                        <option value="Otomotif" {{ old('bidang_industri', $mitra->bidang_industri) === 'Otomotif' ? 'selected' : '' }}>Otomotif</option>
                        <option value="Jasa" {{ old('bidang_industri', $mitra->bidang_industri) === 'Jasa' ? 'selected' : '' }}>Jasa / Agensi</option>
                        <option value="Lainnya" {{ old('bidang_industri', $mitra->bidang_industri) === 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <textarea id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat lengkap perusahaan" required
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">{{ old('alamat', $mitra->alamat) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="email" id="email" name="email" value="{{ old('email', $mitra->email) }}" placeholder="hrd@perusahaan.com" required
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" id="nomor_telepon" name="nomor_telepon" value="{{ old('nomor_telepon', $mitra->nomor_telepon) }}" placeholder="Masukkan nomor telepon" required
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="pic" name="pic" value="{{ old('pic', $mitra->pic) }}" placeholder="Masukkan nama kontak PIC" required
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" id="website" name="website" value="{{ old('website', $mitra->website) }}" placeholder="https://perusahaan.com"
                            class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-10 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="3" placeholder="Masukkan deskripsi singkat tentang perusahaan"
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">{{ old('deskripsi', $mitra->deskripsi) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <select id="status_aktif" name="status_aktif" required
                        class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-10 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                        <option value="Aktif" {{ old('status_aktif', $mitra->status_aktif) === 'Aktif' ? 'selected' : '' }}>Aktif</option>
                        <option value="Tidak Aktif" {{ old('status_aktif', $mitra->status_aktif) === 'Tidak Aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                    </select>
                </div>
